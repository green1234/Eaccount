...
// Prueba para eliminar Base de Datos
...
$lang="es_MX";
    ...
    $msg = new xmlrpcmsg('drop'); // method create_database allow us to create a new database on openerp
    $msg->addParam(new xmlrpcval("admin", "string")); //Super Pass    
    $msg->addParam(new xmlrpcval("fabricacion", "string"));    
